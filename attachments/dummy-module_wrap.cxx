...
#define SWIGTYPE_p_DummyObject swig_types[0]
...
#define SWIGV8_INIT dummy_module_initialize


SWIGV8_ClientData _exports_DummyObject_clientData;


static SwigV8ReturnValue _wrap_new_DummyObject(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Object> self = args.Holder();
  DummyObject *result;
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_DummyObject.");
  result = (DummyObject *)new DummyObject();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_DummyObject, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
#if (SWIG_V8_VERSION < 0x031710)
static void _wrap_delete_DummyObject(v8::Persistent<v8::Value> object, void *parameter) {
  SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (SWIG_V8_VERSION < 0x031900)
  static void _wrap_delete_DummyObject(v8::Isolate *isolate, v8::Persistent<v8::Value> object, void *parameter) {
    SWIGV8_Proxy *proxy = static_cast<SWIGV8_Proxy *>(parameter);
#elif (SWIG_V8_VERSION < SWIGV8_SETWEAK_VERSION)
    static void _wrap_delete_DummyObject(v8::Isolate *isolate, v8::Persistent< v8::Object> *object, SWIGV8_Proxy *proxy) {
#else
      static void _wrap_delete_DummyObject(const v8::WeakCallbackData<v8::Object, SWIGV8_Proxy> &data) {
        v8::Local<v8::Object> object = data.GetValue();
        SWIGV8_Proxy *proxy = data.GetParameter();
#endif
        
        if(proxy->swigCMemOwn && proxy->swigCObject) {
          DummyObject * arg1 = (DummyObject *)proxy->swigCObject;
          delete arg1;
        }
        delete proxy;
...
static swig_type_info _swigt__p_DummyObject = {"_p_DummyObject", "p_DummyObject", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_DummyObject,
  &_swigt__p_char,
};

static swig_cast_info _swigc__p_DummyObject[] = {  {&_swigt__p_DummyObject, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_DummyObject,
  _swigc__p_char,
};
...
#endif
{
  ...
  /* Name: _exports_DummyObject, Type: p_DummyObject, Dtor: _wrap_delete_DummyObject */
v8::Handle<v8::FunctionTemplate> _exports_DummyObject_class = SWIGV8_CreateClassTemplate("_exports_DummyObject");
SWIGV8_SET_CLASS_TEMPL(_exports_DummyObject_clientData.class_templ, _exports_DummyObject_class);
_exports_DummyObject_clientData.dtor = _wrap_delete_DummyObject;
if (SWIGTYPE_p_DummyObject->clientdata == 0) {
  SWIGTYPE_p_DummyObject->clientdata = &_exports_DummyObject_clientData;
}
  ...
  /* class instances */
  /* Class: DummyObject (_exports_DummyObject) */
v8::Handle<v8::FunctionTemplate> _exports_DummyObject_class_0 = SWIGV8_CreateClassTemplate("DummyObject");
_exports_DummyObject_class_0->SetCallHandler(_wrap_new_DummyObject);
_exports_DummyObject_class_0->Inherit(_exports_DummyObject_class);
_exports_DummyObject_class_0->SetHiddenPrototype(true);
v8::Handle<v8::Object> _exports_DummyObject_obj = _exports_DummyObject_class_0->GetFunction();
  ...
  /* register classes */
  exports_obj->Set(SWIGV8_SYMBOL_NEW("DummyObject"), _exports_DummyObject_obj);
...
NODE_MODULE(dummy_module, dummy_module_initialize)
#endif
